...
static void show_about (GSimpleAction *action,
		GVariant      *parameter,
		gpointer       user_data)
{
...
static void new_activated (GSimpleAction *action,
		GVariant      *parameter,
		gpointer       user_data)
{
...
static void menu_button_init (MenuButton *app)
{
}

static void menu_button_class_init (MenuButtonClass *class)
{
...
MenuButton *menu_button_new (void)
{
